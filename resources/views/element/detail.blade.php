        ...
        <div class="alert alert-primary" role="alert">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><b>Score Auditor :</b></td>
                        <td></td>
                        <td>{{ $element->score_auditor }}</td>
                    </tr>
                    <tr>
                        <td><b>Nilai Bobot x Score :</b></td>
                        <td></td>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="bobot" class="form-control" aria-describedby="helpId" value="{{ $element->bobot }}" required>
