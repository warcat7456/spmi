        ...
        <div class="col">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Elements {{ $j->name }}</h6>
                </div>
                <div class="card-body">
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown open">
                                                <button {{ Auth::user()->role == 'Prodi' ? 'hidden' : '' }}
                                                    class="btn btn-info dropdown-toggle" type="button" id="triggerId"
            ...
            <div class="card">
                @if (Auth::user()->role == 'Admin')
                    <div class="card-body">
                        ...
                        <a href="{{ route('tambah-element', 'jenjang=' . $j->jenjang_id) }}"
                            class="btn btn-primary btn-sm float-right">
                            Tambah Element
                        </a>
                        <a href="{{ route('element-sync', 'jenjang=' . $j->id) }}"
                            class="btn btn-primary btn-sm float-right">
                            Sinkron Element
                        </a>
                    </div>
