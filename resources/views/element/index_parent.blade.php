                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (Auth::user()->role == 'Admin')
                                                <a href="{{ route('tambah-element-parent', 'jenjang=' . $j->id . '&l1=' . $i->l1->id . '&l2=' . ($i->l2 ? $i->l2->id : '') . '&l3=' . ($i->l3 ? $i->l3->id : '') . '&l4=' . ($i->l4 ? $i->l4->id : '') . '&indi=' . ($i->id ? $i->id : '')) }}"
            ...
            <div class="card">
                @if (Auth::user()->role == 'Admin')
                    <div class="card-body">
                        ...
                        <a href="{{ route('tambah-element-parent', 'jenjang=' . $j->id) }}"
                            class="btn btn-primary btn-sm float-right">
                            Tambah Element
                        </a>
