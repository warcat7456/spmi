            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
                        ...
                        <p class="fst-italic">
                            Berikut adalah data Program Studi yang terdaftar pada LPM Smart System di Kampus <b>IAIN SAS
                                Babel</b>
                        </p>
                        <ol class="row">
                            @foreach ($fakultas as $fakul)
                                <li class="col-6">
                                    <span>{{ $fakul->nama }}</span>
                                    <ul>
                                        @foreach ($fakul->prodi as $i)
                                            <li class="ms-n1"><i class="bi bi-check-circled"></i><a
