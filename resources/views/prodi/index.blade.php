                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" class="form-control" placeholder="Diploma 3" aria-describedby="helpId" value="{{ $i->name }}" required>
                                                </div>

                                                <div class="form-group">
                                                    <label for="">Kode</label>
                                                    <input type="text" name="kode" class="form-control" placeholder="D3" aria-describedby="helpId" value="{{ $i->kode }}" required>
                                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="Nama Prodi" aria-describedby="helpId" required>
                    </div>

                    <div class="form-group">
                        <label for="">Kode</label>
                        <input type="text" name="kode" class="form-control" placeholder="Kode" aria-describedby="helpId" required>
                    </div>
