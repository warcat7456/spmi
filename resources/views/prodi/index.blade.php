                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="jenjang_id">
                                                                @foreach ($jenjang as $jenj)
                                                                    <option
                                                                        {{ $i->jenjang->id == $jenj->id ? 'selected' : '' }}
                                                                        value="{{ $jenj->id }}">
                                                                        {{ $jenj->name }} - {{ $jenj->kode }}
                                                                    </option>
                                                                @endforeach
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="fakultas_id">
                                                                @foreach ($fakultas as $fakul)
                                                                    <option
                                                                        {{ $i->fakultas->id == $fakul->id ? 'selected' : '' }}
                                                                        value="{{ $fakul->id }}">
                                                                        {{ $fakul->nama }}
                                                                        {{ $fakul->singkatan ? '- ' . $fakul->singkatan : null }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Nama Prodi"
