                ...
                <div class="card-body">
                    ...
                    <form action="/fakultas/put/{{ $i->id }}" method="post" enctype="multipart/form-data">
                        ...
                        <div hidden>
                            <div class="form-group">
                                ...
                                <input type="text" name="nama" class="form-control" placeholder=""
                                    aria-describedby="helpId" value="{{ $i->nama }}" required>
                            </div>

                            <div class="form-group">
                                <label for="">Singkatan</label>
                                <input type="text" name="singkatan" class="form-control" placeholder=""
                                    aria-describedby="helpId" value="{{ $i->singkatan }}">
                            </div>
                            <div class="form-group">
                                <label for="">Urutan</label>
                                <input type="number" name="urutan" class="form-control" placeholder=""
                                    aria-describedby="helpId" value="{{ $i->urutan }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" accept="image/*" name="foto_file" class="form-control"
