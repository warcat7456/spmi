                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="150px">
                                    ...
                                    <a class="btn btn-info btn-sm" href="{{  url('edit-profil-fakultas/'.$i->id) }}">
                                        Profil
                                    </a>
                            ...
                            {{-- EDIT DATA --}}
                            <div class="modal fade" id="modelEdit{{ $i->id }}" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <form action="/fakultas/put/{{ $i->id }}" method="POST">
                            ...
                            {{-- HAPUS DATA --}}
                            <div class="modal fade" id="modelHapus{{ $i->id }}" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <form action="/fakultas/hapus/{{ $i->id }}" method="post">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                @csrf
                                                @method('delete')
                                                Apa kamu yakin akan menghapus data <b>{{ $i->nama }}</b>
...
<div class="modal fade" id="modelTambah" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="/fakultas/post" method="post">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="">Nama Fakultas</label>
                        <input type="text" name="nama" class="form-control" placeholder="Nama Fakultas" aria-describedby="helpId" required>
                    </div>

                    <div class="form-group">
                        <label for="">Singkatan</label>
                        <input type="text" name="singkatan" class="form-control" placeholder="Singkatan" aria-describedby="helpId" required>
                    </div>

                    <div class="form-group">
                        <label for="">Urutan</label>
                        <input type="text" name="urutan" class="form-control" placeholder="Urutan" aria-describedby="helpId" required>
                    </div>
