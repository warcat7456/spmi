        ...
        <div class="col-2">
            <div class="card">
                <div class="card-body mr-auto">
                    ...
                    <button type="button" class="btn btn-primary btn-sm float-right mb-2 d-block w-100" data-toggle="modal"
                        data-target="#modelTambah">
                        Tambah Indikator
                    </button>

                    <a href="{{ route('element-sync', 'jenjang=' . $j->id) }}"
                        class="btn btn-primary btn-sm float-right d-block w-100">
                        Sinkron Element
                    </a>
                </div>
            </div>
