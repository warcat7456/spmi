...
@section('content')
        ...
        <div class="col">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Halaman Statis</h6>
                </div>
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                {{ $halamanStatis }}
                                {{-- //TODO: Add foreach function to list static pages --}}
                                {{-- <tr>
                                    <td>{{ $i->name }}</td>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-primary btn-sm float-right" data-toggle="modal"
                        ...
                        <i class="fa-solid fa-plus"></i> Halaman Statis
                    </button>
                </div>
            </div>
            <hr>
    ...
    <div class="modal fade" id="modelTambah" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form action="{{ route('halaman-statis.store') }}" method="post">
                @method('POST')
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
