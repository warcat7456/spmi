            ...
            <div class="card-body">
                ...
                <form action="/users/put/{{ $i->id }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" value="{{ $i->name }}" class="form-control" aria-describedby="helpId" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" value="{{ $i->email }}" class="form-control" aria-describedby="helpId" required>
                    </div>
