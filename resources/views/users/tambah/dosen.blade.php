            ...
            <div class="card-body">
                ...
                <form action="/users/store" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="role" class="form-control" aria-describedby="helpId" value="Prodi" hidden required>
                        <input type="text" name="prodi_kode" class="form-control" aria-describedby="helpId" value="0" hidden required>
                    </div>
                    <div class="form-group">
